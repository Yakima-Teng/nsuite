 ...
 * @property {function (ParamsQiniuOSSUploadFileCallbackWithoutError | ParamsQiniuOSSUploadFileCallbackWithError): void} [uploadCallback] - callback function for upload progress
 */
  ...
  for (const group of groups) {
    ...
    const list = await Promise.all(
      group.map(({ localPath, key }) => {
        /** @type {() =>Promise<ReturnQiniuOSSUploadLocalFile | void>} */
