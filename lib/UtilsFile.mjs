 ...
 */
export const zipFile = async (options) => {
 ...
 * @returns {Promise<number>} - A promise that resolves with final zip file size in Bytes when the zip operation is complete.
 */
export const zipFolder = async (options) => {
 ...
 * @param {import('filesize').FilesizeOptions & { output?: 'string' }} [options]
 * @returns {string}
 */
export const getReadableFileSize = (size, options) => {
