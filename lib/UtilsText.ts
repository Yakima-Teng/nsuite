 ...
 *
 * @param options - The options for generating the summary.
 * @param options.apiKey - The API key for OpenAI.
 * @param options.baseUrl - The base URL for the OpenAI API.
 * @param options.model - The model to use for generating the summary.
 * @param options.language - The language in which the summary should be written.
 * @param options.maxWords - The maximum number of words the summary should contain.
 * @param options.content - The content to be summarized.
...
export async function generateSummary({
  ...
  try {
    ...
    logInfo(JSON.stringify(completion));
